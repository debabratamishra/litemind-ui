...
class CleanFormatter(logging.Formatter):
    ...
    LOGGER_NAME_MAPPING = {
        ...
        'uvicorn': 'server',
        'backend.app.services.host_service_manager': 'host_service',
        'backend.app.services.rag_service': 'rag_service',
        'backend.logging_config': 'config',
    }
...
def get_logging_config(environment: str | None = None) -> Dict[str, Any]:
    ...
    config = {
        ...
        'formatters': {
            ...
            'simple': {
                '()': 'backend.logging_config.CleanFormatter',
        ...
        'loggers': {
            ...
            'backend.logging_config': {
                'level': 'WARNING',  # Hide backend.logging_config setup messages from console
                'handlers': ['console'],
                'propagate': False
            },
            ...
            'backend.app.services.host_service_manager': {
                'level': 'WARNING',
                'handlers': ['console'],
                'propagate': False
            }
    ...
    if environment == 'development':
        ...
        config['loggers']['backend.logging_config'] = {
            'level': 'WARNING',
            'handlers': ['console', 'file_debug'],
            'propagate': False
        }
