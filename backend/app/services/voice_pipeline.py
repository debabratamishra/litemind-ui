...
from backend.app.services.llm_gateway import stream_completion
...
from backend.app.services.user_memory_service import load_memory_block, run_memory_update
