...
from backend.app.backend.api.auth_deps import User, get_current_user  # noqa: E402
from backend.app.backend.models.api_models import (  # noqa: E402
    ChatRequestEnhanced,
    ChatResponse,
    MemoryStatsResponse,
    SerpTokenCheck,
...
from backend.app.services.conversation_memory import get_memory_service  # noqa: E402
from backend.app.services.llm_gateway import complete_text, stream_completion  # noqa: E402
from backend.app.services.user_memory_service import load_memory_block, run_memory_update  # noqa: E402
from backend.app.services.web_search_service import WebSearchService  # noqa: E402
from backend.app.skills import chat_skill_registry  # noqa: E402
...
def _build_messages_with_history(
    ...
    if request.is_voice_mode:
        from backend.app.backend.core.config import DEFAULT_CHAT_SYSTEM_PROMPT_VOICE
