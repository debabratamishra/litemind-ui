...
description: "The technical backbone of LiteMindUI: architecture, processes and ports, directory layout, design patterns, LLM backends, configuration, and how to run it."
---
...
<p>The backend lives in <code>backend/app/</code>; the UI in <code>nextjs-frontend/src/</code>.</p>
<div class="tree">
<span class="k">backend/app/</span>
...
├── <span class="k">backend/app/</span>           <span class="c">App Router pages & layouts</span>
...
<h3>LiteLLM Gateway <span style="font-weight:400;font-size:.9rem;color:var(--muted)">(<code>backend/app/services/llm_gateway.py</code>)</span></h3>
<p>
...
<h3>Pluggable Skill Layer <span style="font-weight:400;font-size:.9rem;color:var(--muted)">(<code>backend/app/skills/</code>)</span></h3>
<p>
...
<h3>RAG system <span style="font-weight:400;font-size:.9rem;color:var(--muted)">(<code>backend/app/services/rag_service.py</code>)</span></h3>
<p>
...
<h3>Conversation memory <span style="font-weight:400;font-size:.9rem;color:var(--muted)">(<code>backend/app/services/conversation_memory.py</code>)</span></h3>
<p>
...
<h3>Generative UI <span style="font-weight:400;font-size:.9rem;color:var(--muted)">(<code>backend/app/backend/api/chat.py</code>)</span></h3>
<p>
...
<h3>Authentication system <span style="font-weight:400;font-size:.9rem;color:var(--muted)">(<code>backend/app/backend/api/auth*</code>)</span></h3>
<p>
...
<p style="margin-top:28px;"><a href="..">← Back to home</a></p>
  </div>
</section>
